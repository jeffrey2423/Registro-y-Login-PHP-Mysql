<?php
    ...
    $id_sede = $_POST['id_sede'];
     ...
     $queryLimit="SELECT docente.name, docente.lastname, docente.image,
     docente.email, docente.descripcion, docente.created_at, sede.nombre_sede FROM docente INNER JOIN sede ON docente.sede_id = sede.id_sede WHERE docente.sede_id = '$id_sede' AND docente.teacher = 1";
      ...
      if ($filas>0) {
        ...
        while ($result=mysqli_fetch_assoc($executeLimit)) { 
           ...
           <div class="card my-3" style="max-width: 20rem; display: inline-block; margin-right:5px;">
                <img src="./public/img/'.$result['image'].'" class="card-img-top"  alt="Card image cap" style="width: 100%; height:300px;">
                <div class="card-body">
